...
local_file_path = "C:\\Users\\ihars\\OneDrive\\Desktop\\DE-Project\\sales_data_to_s3\\"
def upload_to_s3(s3_directory, s3_bucket, local_file_path):
    s3_prefix = f"{s3_directory}"
    try:
        for root, dirs, files in os.walk(local_file_path):
            for file in files:
                print("Current file to be uploaded:- ",file)
                print("Root path Local:- ",root)
